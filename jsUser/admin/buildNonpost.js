function buildHTMLnonPost(){
    ...
    '<button type="button" class="btn btn-success btn-accept-mypost">Duyệt</button></pre></p>'+       
      '</div>'+
    ...
    $(".form-nonpost-admin").html(html)
    });
    }  
    //================Sự kiện khi click vào một button xóa=========
    $('.form-nonpost-admin').on('click','.btn-xoa-mypost',function(){
     ...
     //================Sự kiện khi click vào một button accept=========
     $('.form-nonpost-admin').on('click','.btn-accept-mypost',function(){
        
        var mabaiviet = $(this).parents('.item-post').attr("data-mabaiviet");
    
            
                dataSend = {event:'accept',mabaiviet:mabaiviet};
